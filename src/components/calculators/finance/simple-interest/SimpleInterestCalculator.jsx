    ...
    return (
        <div className="flex flex-col items-center p-4 md:p-8">
            <Header
                ...
                subtitle="Calculate Simple Interest (SI)"
            />
                ...
                <div className="glass-card rounded-3xl p-6 md:p-8 animate-fade-in-up delay-200">
                    ...
                    <div className="gradient-primary rounded-2xl p-5 text-center mb-6">
                        ...
                        <div className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">
                            {new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR', maximumFractionDigits: 0 }).format(results.simple.interest)}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 mb-8">
                        <ResultCard
                            label="Total Amount"
                            value={results.simple.totalAmount}
                            subText="Principal + Yearly Interest"
                        />
                    </div>
                    ...
                    <div className="mt-8 border-t border-white/10 pt-8">
                        ...
                        <GrowthLineChart
                            ...
                            lines={[
                                { dataKey: 'simple', name: 'Simple Interest', color: '#10b981' },
                                { dataKey: 'compound', name: 'Compound Interest', color: '#94a3b8' } // Removed dash for cleaner look or keep it solid
                            ]}
                            xAxisKey="year"
                            height={250}
                        />
